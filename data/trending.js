window.__TRENDING_DATA__ = {
  ...
  "since": "daily",
  "generated_at": "2026-08-05T04:23:59.183204+00:00",
  "items": [
    {
      "rank": 1,
    ...
    },
    {
      ...
      "descriptions": {
        "zh": "Reverse Engineering / Authorized Penetration Testing / Security Research Skill Router Pack AI-powered routing + On-demand toolchain bootstrapping + Self-evolving knowledge base Supports Claude Code, Kiro, Cursor, Cline, and other AI coding clients 逆向/渗透/安全技能路由包 - AI 自动路由 + 按需自举工具链 + 自动进化经验库 | 支持 Claude Code / Kiro / Cursor / Cline 等代码 AI 客户端",
    ...
    },
    {
      ...
      "descriptions": {
        "zh": "ADR 通过可观察性、安全基准测试和威胁检测来保护企业 AI 代理。部署在 Uber。",
        "en": "ADR secures enterprise AI agents through observability, security benchmarking, and threat detection. Deployed at Uber."
      },
      "language": "Python",
      "stars_total": 744,
      "forks_total": 71,
