    ...
    zh: {
      ...
      pages: {
        home: {
          ...
          "nav.trending": "热门项目",
          "nav.contact": "联系",
          "nav.searchPlaceholder": "搜索 AI / Repo / 文章",
          "nav.searchAction": "搜索",
          ...
          "hero.subhead": "Android × AI 工程实践，专注端侧智能、Agent、LLM 集成与 AI 产品化。",
          "hero.primaryAction": "进入 AI 实验室",
          "hero.secondaryAction": "查看技术博客",
          "hero.metric.projects": "AI 项目",
          "hero.metric.commits": "GitHub 提交",
          "hero.metric.reads": "博客阅读",
          "about.eyebrow": "个人定位",
          "about.title": "关于与愿景",
          ...
          "about.badge": "Android × AI",
          "about.focus.caption": "工程主线",
          "about.research.caption": "研究线索",
          "models.eyebrow": "AI Model Watch",
          "models.title": "AI 模型观察榜",
          "models.copy": "以通用能力、工程可用性和生态成熟度为准，做一个首页常驻的模型观察视图。",
          "models.note": "该榜单为站内手动观察排序，用来快速建立模型直觉，不代表严格基准测试结果。",
          "models.badge": "榜单",
          "models.scoreLabel": "观察值",
          "models.item.1.body": "综合推理、工具调用与工程集成最稳，适合作为旗舰 AI 能力的基线。",
          "models.item.2.body": "长文本写作和代码协作体验突出，适合需要高质量表达的工作流。",
          "models.item.3.body": "多模态与生态整合能力强，适合作为搜索、办公和代理场景的中枢模型。",
          "models.item.4.body": "性价比和推理效率非常强，适合高频调用和大规模上线场景。",
          "models.item.5.body": "中文任务、工具兼容和企业落地路径清晰，适合本地生态集成。",
          "models.item.6.body": "开源生态活跃，便于二次训练、私有化部署与端云协同实验。",
          ...
          "homePosts.eyebrow": "写作",
          "homePosts.title": "最近文章",
          "homePosts.copy": "从博客内容源中自动挑选精选或最新文章，快速进入完整的技术记录。",
          "homePosts.all": "查看全部博客",
          "homePosts.loading": "加载中",
          "homePosts.loadingTitle": "正在读取博客文章",
          "homePosts.loadingCopy": "首页会展示精选文章，不足时用最新文章补齐。",
          "feed.eyebrow": "Signal Layer",
          "feed.title": "最近文章 / AI 动态 / 技术标签",
          "feed.copy": "把长期写作、短期观察和工程关键词放在同一层，形成更像个人 AI 工作台的扩展区。",
          "articles.title": "最近文章",
          "articles.badge": "Blog",
          "articles.item.1.meta": "路线图",
          "articles.item.1.title": "AI on Android：端侧推理落地路线图",
          "articles.item.1.body": "从模型选择、量化蒸馏到上线验证，梳理端侧 AI 的完整落地链路。",
          "articles.item.1.cta": "阅读全文",
          "articles.item.2.meta": "体验设计",
          "articles.item.2.title": "设计有温度的 AI 体验",
          "articles.item.2.body": "围绕可信度、透明度和反馈闭环，重做移动端 AI 助手的交互节奏。",
          "articles.item.2.cta": "阅读全文",
          "articles.item.3.meta": "实验场",
          "articles.item.3.title": "AI Chat 工作台",
          "articles.item.3.body": "把多模型对话、附件、Token 面板和流式消息集中到一个实验入口。",
          "articles.item.3.cta": "打开工作台",
          "pulse.title": "AI 动态",
          "pulse.badge": "Pulse",
          "pulse.item.1.title": "模型竞争转向 Agent 能力",
          "pulse.item.1.body": "工具调用、长上下文和自动执行链路，正在成为新一轮模型差异化核心。",
          "pulse.item.2.title": "端侧 AI 正在回到产品中心",
          "pulse.item.2.body": "推理效率、成本和隐私要求，让端云协同重新成为移动 AI 的关键优势。",
          "pulse.item.3.title": "GitHub Trending 继续主导信号源",
          "pulse.item.3.body": "开源项目热度变化仍然是观察 AI 生态方向最快的窗口之一。",
          "tags.title": "技术标签",
          "tags.badge": "Stack",
          "tags.copy": "这三类标签代表我当前最关注的工程方向：端侧性能、Agent 编排和模型产品化。",
          "tags.note": "如果你也在做 Android × AI，欢迎直接进入工作台开始交流。",
        ...
        blogIndex: {
          ...
          "header.intro": "用 Markdown 记录技术、产品和 AI 自动化实验。这里的文章支持标签筛选、关键词搜索和多平台发布状态。",
          "blog.kicker": "写作系统",
          "blog.search.label": "搜索文章",
          "blog.search.placeholder": "搜索标题、标签、摘要或正文关键词",
          "blog.loading": "加载中",
          "blog.loadingIndex": "正在加载文章索引...",
          "blog.all": "全部",
          "blog.count": "{visible} / {total} 篇文章",
          "blog.empty": "没有匹配的文章，换个关键词或标签试试。",
          "blog.error": "文章索引加载失败，请稍后重试。",
          "blog.read": "阅读全文 →",
    ...
    en: {
      ...
      pages: {
        home: {
          ...
          "nav.contact": "Contact",
          "nav.searchPlaceholder": "Search AI / repos / posts",
          ...
          "hero.subhead": "Android × AI engineering focused on on-device intelligence, agents, LLM integration, and productized AI systems.",
          "hero.primaryAction": "Enter the AI Lab",
          "hero.secondaryAction": "Read the blog",
          "hero.metric.projects": "AI projects",
          "hero.metric.commits": "GitHub commits",
          "hero.metric.reads": "Blog reads",
          ...
          "about.badge": "Android × AI",
          "about.focus.caption": "Engineering track",
          "about.research.caption": "Research track",
          "models.eyebrow": "AI Model Watch",
          "models.title": "AI Model Watchlist",
          "models.copy": "A permanent model board for the homepage, ranked by broad capability, engineering usefulness, and ecosystem maturity.",
          "models.note": "This is a manual site-level ranking for fast orientation, not a formal benchmark leaderboard.",
          "models.badge": "Rank",
          "models.scoreLabel": "Score",
          "models.item.1.body": "The most stable all-around choice for reasoning, tool use, and production integration.",
          "models.item.2.body": "Excellent at long-form writing and code collaboration when answer quality matters most.",
          "models.item.3.body": "Strong multimodal range and product ecosystem fit for search, office, and agent workflows.",
          "models.item.4.body": "Outstanding cost-efficiency and inference speed for high-volume production scenarios.",
          "models.item.5.body": "Clear strength in Chinese tasks, tool compatibility, and enterprise deployment paths.",
          "models.item.6.body": "A lively open-source ecosystem that is ideal for fine-tuning and private deployment experiments.",
          "trending.eyebrow": "GitHub Radar",
          ...
          "homePosts.eyebrow": "Writing",
          "homePosts.title": "Recent posts",
          "homePosts.copy": "Selected or recent posts are pulled from the blog content source for a fast path into the full notes.",
          "homePosts.all": "View all posts",
          "homePosts.loading": "Loading",
          "homePosts.loadingTitle": "Loading blog posts",
          "homePosts.loadingCopy": "The homepage shows featured posts first, then fills the list with recent writing.",
          "feed.eyebrow": "Signal Layer",
          "feed.title": "Recent Posts / AI Pulse / Tech Tags",
          "feed.copy": "This lower block combines long-form writing, short-cycle observations, and engineering keywords into a more personal AI dashboard.",
          "articles.title": "Recent Posts",
          "articles.badge": "Blog",
          "articles.item.1.meta": "Roadmap",
          "articles.item.1.title": "AI on Android: A Roadmap for On-Device Inference",
          "articles.item.1.body": "A practical delivery chain for on-device AI, from model choice and compression to shipping validation.",
          "articles.item.1.cta": "Read article",
          "articles.item.2.meta": "Design",
          "articles.item.2.title": "Designing AI Experiences with Warmth",
          "articles.item.2.body": "A redesign of mobile AI interaction around trust, transparency, and feedback loops.",
          "articles.item.2.cta": "Read article",
          "articles.item.3.meta": "Lab",
          "articles.item.3.title": "AI Chat Workspace",
          "articles.item.3.body": "A single experiment surface for multi-model chat, attachments, token panels, and streaming replies.",
          "articles.item.3.cta": "Open workspace",
          "pulse.title": "AI Pulse",
          "pulse.badge": "Pulse",
          "pulse.item.1.title": "Model competition is shifting toward agents",
          "pulse.item.1.body": "Tool use, long context, and execution chains are quickly becoming the most meaningful product differentiators.",
          "pulse.item.2.title": "On-device AI is back at the center",
          "pulse.item.2.body": "Efficiency, privacy, and cost pressure are pulling device-cloud collaboration back into the core mobile strategy.",
          "pulse.item.3.title": "GitHub Trending remains the fastest signal",
          "pulse.item.3.body": "Open-source momentum is still one of the quickest ways to read direction changes across the AI ecosystem.",
          "tags.title": "Tech Tags",
          "tags.badge": "Stack",
          "tags.copy": "These tags map the engineering areas I care about most right now: on-device performance, agent orchestration, and model productization.",
          "tags.note": "If you're also building Android × AI systems, jump into the workspace and start a conversation.",
          "footer.copy": "© 2025 WK1995 · Inspired by the future of AI on Android",
        },
        blogIndex: {
          ...
          "header.intro": "Markdown notes on technology, product thinking, and AI automation experiments, with tags, search, and publishing metadata.",
          "blog.kicker": "Writing System",
          "blog.search.label": "Search posts",
          "blog.search.placeholder": "Search titles, tags, summaries, or article text",
          "blog.loading": "Loading",
          "blog.loadingIndex": "Loading post index...",
          "blog.all": "All",
          "blog.count": "{visible} / {total} posts",
          "blog.empty": "No matching posts. Try another keyword or tag.",
          "blog.error": "The post index failed to load. Please try again later.",
